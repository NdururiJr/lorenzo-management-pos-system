 ...
 * assigning drivers, and scheduling deliveries.
 *
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        <div>
          <div className="mb-4 flex items-center justify-between">
            <div>
              <h2 className="text-lg font-semibold text-black">Select Orders for Delivery</h2>
              <p className="text-sm text-gray-600">
                Choose orders that are ready for delivery and create a batch
              </p>
            </div>
