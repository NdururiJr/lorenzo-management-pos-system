      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight" style={{ color: 'white' }}>
            Your Privacy
            <br />
            <span className="text-brand-blue-light">Matters to Us</span>
          </h1>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white/70 backdrop-blur-xl border-2 border-white/60 rounded-3xl shadow-card p-8 md:p-12">
            <div className="prose prose-lg max-w-none">
              ...
              <p>
                To exercise these rights, please contact us at <a href="mailto:privacy@lorenzo.co.ke">privacy@lorenzo.co.ke</a> or call us at <a href="tel:+254725462859">+254 725 462 859</a>.
              </p>
