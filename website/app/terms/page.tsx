      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-white">
            Terms &
            <br />
            <span className="text-lorenzo-gold">Conditions</span>
          </h1>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white/70 backdrop-blur-xl border-2 border-white/60 rounded-3xl shadow-card p-8 md:p-12">
            <div className="prose prose-lg max-w-none">
              ...
              <h3>Service Areas</h3>
              <p>
                We provide pickup and delivery services throughout Nairobi and environs via our 21+ branches. Service availability may vary by location.
              </p>
