    ...
    questions: [
      {
        ...
        answer: 'We serve all of Nairobi through our 21+ branches. Pickup and delivery are free across Nairobi. Contact us to check availability for your specific area.',
      },
      {
        id: 'delivery-times',
      ...
      },
      {
        ...
        answer: 'If you\'re not available during delivery, our driver will contact you to reschedule. Your items will be safely stored at our facility. You can also choose to collect your items from any of our 21+ branches across Nairobi at your convenience.',
      },
    ],
  },
  {
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-white">
            Your Questions,
            <br />
            <span className="text-lorenzo-gold">Answered</span>
          </h1>
...
function FAQFooterCTA() {
  return (
    <section className="relative py-16 overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 bg-linear-to-br from-white via-lorenzo-accent-teal-50 to-lorenzo-accent-teal-100" />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white/70 backdrop-blur-xl border-2 border-white/60 rounded-3xl shadow-2xl p-8 md:p-12 text-center">
            <h2 className="text-3xl sm:text-4xl font-bold text-black mb-4">
              Didn't Find Your
              <span className="text-lorenzo-accent-teal"> Answer?</span>
            </h2>
