...
const socialLinks = [
  ...
  { name: 'Email', icon: Mail, href: '#', color: '#2DD4BF' },
];
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-black mb-4">
              Related
              <span className="text-lorenzo-accent-teal"> Articles</span>
            </h2>
  ...
  return (
    ...
    >
      <Link href={`/blog/${post.slug}`}>
        ...
        {/* Content */}
        <div className="p-5">
          <h3 className="text-lg font-bold text-black mb-2 group-hover:text-lorenzo-accent-teal transition-colors duration-300 line-clamp-2">
            {post.title}
          </h3>
