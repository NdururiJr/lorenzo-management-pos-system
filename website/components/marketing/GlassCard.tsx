  ...
  return (
    <div
      className={cn(
        ...
        'relative rounded-2xl',
        'bg-lorenzo-accent-teal-50/20 backdrop-blur-glass',
        'border border-lorenzo-accent-teal/30',
        'shadow-glass',

        // Inner gradient with blue
        'before:absolute before:inset-0',
        'before:rounded-2xl',
        'before:bg-gradient-to-br before:from-lorenzo-accent-teal/10 before:to-transparent',
        'before:opacity-60',
        'before:-z-10',
        ...
        hover && [
          ...
          'hover:border-lorenzo-accent-teal/50',
          'hover:bg-lorenzo-accent-teal-50/30',
        ],
