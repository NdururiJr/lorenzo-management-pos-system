...
export function Newsletter() {
  ...
  return (
    <section className="relative py-16 overflow-hidden bg-white" ref={ref}>
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-lorenzo-accent-teal/30 via-lorenzo-accent-teal-dark/25 to-lorenzo-accent-teal/30" />
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-lorenzo-accent-teal-dark rounded-full blur-3xl opacity-15" />
        ...
        >
          ...
          <div className="bg-white/90 backdrop-blur-xl border-2 border-white/60 rounded-3xl shadow-2xl p-6 md:p-10">
            ...
            <div className="text-center mb-6">
              ...
              >
                Get Exclusive Tips
                <span className="text-lorenzo-accent-teal"> & Offers</span>
              </motion.h2>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className={cn(
                        ...
                        'focus:border-lorenzo-accent-teal focus:ring-2 focus:ring-lorenzo-accent-teal/20',
            ...
            >
              ...
              >
                <p className="text-sm text-gray-600">
                  <span className="font-bold text-lorenzo-accent-teal">Join 500+ subscribers</span> getting
