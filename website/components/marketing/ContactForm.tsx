          ...
          <div className="bg-white/70 backdrop-blur-xl border-2 border-white/60 rounded-3xl shadow-2xl p-6 md:p-10">
            ...
            <div className="text-center mb-8">
              <motion.span
                ...
                className="inline-block px-4 py-1.5 rounded-full bg-lorenzo-accent-teal text-white text-sm font-medium mb-4 shadow-lg"
              >
                SEND US A MESSAGE
              </motion.span>
              ...
              >
                Let's Start a
                <span className="text-lorenzo-accent-teal"> Conversation</span>
              </motion.h2>
            ...
            >
              ...
              <Button
                ...
                className="w-full text-white font-semibold py-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed bg-lorenzo-accent-teal hover:bg-lorenzo-accent-teal/90"
              >
                {isSubmitting ? (
