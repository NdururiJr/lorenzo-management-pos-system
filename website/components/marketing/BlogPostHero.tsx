    ...
    <section className="relative pt-32 pb-16 overflow-hidden bg-white">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <Link
            href="/blog"
            className="inline-flex items-center gap-2 text-lorenzo-accent-teal font-semibold mb-8 hover:gap-3 transition-all duration-300"
          >
          ...
          {/* Category Badge */}
          <span
            className="inline-block px-4 py-1.5 rounded-full bg-lorenzo-accent-teal text-white text-sm font-bold mb-6 shadow-lg"
          >
            {category}
          </span>
          ...
          <div className="flex flex-wrap items-center gap-6 mb-8 text-gray-600">
            <div className="flex items-center gap-2">
              <User className="w-5 h-5 text-lorenzo-accent-teal" />
              <span className="font-medium">{author}</span>
            </div>
            <div className="flex items-center gap-2">
              <Calendar className="w-5 h-5 text-lorenzo-accent-teal" />
              <span>{date}</span>
            </div>
            <div className="flex items-center gap-2">
              <Clock className="w-5 h-5 text-lorenzo-accent-teal" />
              <span>{readTime}</span>
            </div>
          </div>
