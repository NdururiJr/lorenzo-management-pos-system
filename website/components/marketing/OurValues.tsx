...
export function OurValues() {
  ...
  return (
    <section className="relative py-24 overflow-hidden bg-white">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-lorenzo-accent-teal-light rounded-full blur-3xl opacity-20" />
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-lorenzo-accent-teal rounded-full blur-3xl opacity-15" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-lorenzo-accent-teal-100 rounded-full blur-3xl opacity-10" />
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-black mb-4">
            What We
            <span className="text-lorenzo-accent-teal"> Stand For</span>
          </h2>
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full text-center">
        {/* Icon */}
        <motion.div
          className="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-5 shadow-lg bg-lorenzo-accent-teal"
