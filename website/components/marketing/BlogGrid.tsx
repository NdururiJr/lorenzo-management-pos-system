...
export function BlogGrid() {
  ...
  return (
    <section className="relative py-16 overflow-hidden bg-white">
      ...
      <div className="absolute top-0 left-0 w-96 h-96 bg-lorenzo-accent-teal-light rounded-full blur-3xl opacity-15" />
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-lorenzo-accent-teal rounded-full blur-3xl opacity-10" />
      ...
      <div className="relative z-10 p-6 flex-1 flex flex-col">
        ...
        <div className="flex items-center gap-4 mb-3 text-sm text-gray-600">
          <div className="flex items-center gap-1">
            <User className="w-4 h-4" style={{ color: '#2DD4BF' }} />
        ...
        {/* Title */}
        <h3 className="text-xl font-bold text-black mb-3 group-hover:text-lorenzo-accent-teal transition-colors duration-300 line-clamp-2">
          {post.title}
        </h3>
        ...
        <Link
          href={`/blog/${post.slug}`}
          className="inline-flex items-center gap-2 text-lorenzo-accent-teal font-semibold text-sm group-hover:gap-3 transition-all duration-300"
        >
          Read More
