...
const services = [
  ...
  },
  {
    ...
    description: '2-hour turnaround for urgent needs.',
    features: [
      'Same-day processing',
      'Priority handling',
      'Quality guaranteed',
  ...
  },
  {
    ...
    description: 'Free pickup and delivery service across Nairobi.',
    features: [
      'Free across Nairobi',
      'Flexible scheduling',
      'Real-time tracking',
...
export function ServicesGrid() {
  ...
  return (
    <section className="relative py-24 overflow-hidden bg-white">
      ...
      <div className="absolute top-0 left-0 w-96 h-96 bg-lorenzo-accent-teal rounded-full blur-3xl opacity-10" />
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-lorenzo-gold rounded-full blur-3xl opacity-10" />
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-black mb-4">
            ...
            <span className="text-lorenzo-accent-teal-dark"> Solutions</span>
          </h2>
...
function ServiceCard({ service, index }: ServiceCardProps) {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute inset-0 bg-linear-to-br from-lorenzo-accent-teal/10 via-lorenzo-accent-teal-light/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"
      />
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        {/* Service Name */}
        <h3 className="text-2xl font-bold text-black mb-3 group-hover:text-lorenzo-accent-teal-dark transition-colors duration-300">
          {service.name}
        </h3>
