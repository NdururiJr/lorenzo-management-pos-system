...
const contactMethods = [
  ...
  },
  {
    ...
    icon: MapPin,
    title: 'Locations',
    details: '21+ Branches in Nairobi',
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-black mb-4">
            We're Here to
            <span className="text-lorenzo-accent-teal"> Help</span>
          </h2>
        ...
        >
          ...
          >
            {/* Animated gradient */}
            <div className="absolute inset-0 bg-gradient-to-br from-lorenzo-accent-teal/5 via-lorenzo-accent-teal-light/5 to-transparent pointer-events-none" />
