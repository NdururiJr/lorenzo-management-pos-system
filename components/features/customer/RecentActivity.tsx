        ...
        <div className="space-y-3">
          {orders.map((order) => (
            <Link key={order.orderId} href={`/orders/${order.orderId}`}>
              <div className="flex items-center justify-between py-2 hover:bg-gray-50 rounded px-2 -mx-2 cursor-pointer">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-600">
                      ...
                      on {formatDate(order.actualCompletion?.toDate() || order.updatedAt.toDate())}
                    </div>
                  </div>
                </div>
