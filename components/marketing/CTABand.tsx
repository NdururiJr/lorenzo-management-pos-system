...
export function CTABand({
  ...
  const gradientClass = variant === 'blue'
    ? 'bg-gradient-to-r from-brand-blue via-brand-blue-dark to-brand-blue'
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <Button
                asChild
                size="lg"
                className="bg-white text-brand-blue hover:bg-gray-100 rounded-full px-8 py-6 text-lg font-semibold shadow-xl hover:shadow-2xl transition-all hover:scale-105"
              >
