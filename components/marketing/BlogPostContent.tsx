        ...
        <div className="max-w-3xl mx-auto">
          <div
            className={cn(
              ...
              'prose-blockquote:border-l-brand-blue prose-blockquote:bg-brand-blue-50 prose-blockquote:rounded-r-xl prose-blockquote:py-4',
...
export const sampleBlogContent = (
  <>
    ...
    <p>
      Have questions about caring for a specific garment? Contact us today or visit our location in
      Kilimani for expert advice and service you can trust.
    </p>
  </>
);
