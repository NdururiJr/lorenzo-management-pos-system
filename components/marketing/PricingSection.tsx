...
export function PricingSection() {
  ...
  return (
    <section className="relative py-24 overflow-hidden bg-white">
      ...
      <div className="absolute top-1/3 right-1/3 w-[500px] h-[500px] bg-brand-blue-100 rounded-full blur-3xl opacity-10" />
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <br />
          <Link href="/customer-login" className="text-brand-blue font-semibold hover:underline">
  ...
  return (
    <motion.article
      ...
      className={cn(
        ...
        'border-2',
        tier.popular ? 'border-brand-blue shadow-2xl' : 'border-white/60 shadow-card',
        'hover:shadow-2xl',
      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <h3
          className={cn(
            ...
            tier.popular ? 'text-brand-blue' : 'text-black group-hover:text-brand-blue'
          )}
        >
          {tier.name}
        </h3>
