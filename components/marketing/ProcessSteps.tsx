      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            >
              <Link href="/services" className="hover:bg-[#22BBFF] hover:text-white transition-all">
            ...
            <Button
              ...
              size="lg"
              variant="ghost"
              className="text-brand-blue hover:text-brand-blue-dark hover:bg-brand-blue-50 rounded-full font-semibold transition-all duration-300"
            >
